...
function soldList() {
    ...
    for (var i = 0; i < b.length; i++) {
        ...
        var tpTdText = document.createTextNode("" + TP);
        tpTd.appendChild(tpTdText);
        tr.appendChild(tpTd);
        target.insertBefore(tr, target2);
    }
    document.getElementById("some").innerHTML = b.length + " Sản phẩm đã được bán!"
    document.getElementById("saleTotal").innerHTML = "" + tp;
}
soldList()
